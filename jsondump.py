...
# Prints the text.    
             img = cv2.rectangle(result, (x, y - ht), (x + wt, y), (255, 0,0), 3)
    ...
    #print("x,y,w,h:",x,y,w,h)
        ...
        #print(cropped_image)
             ...
             cv2.imwrite(file+'/'+temp,cropped_image)
...
# Prints the text.    
    ...
    #print("x,y,w,h:",x,y,w,h)
        ...
        #print(image.shape) 
                ...
                dump = {'ID': i, 'Name': 'img' + str(i),'ToolType': None, 'ClassifierThinks': None, 'Location': 0, 'Who': None, 'IDAvail': False,'IDMark': None , 'CheckedOut': False,'X': x, 'Y' :y ,'W' :w , 'H' : h, 'picfull': file+'/img' +temp, 'picnull': file+'/img' +temp, 'Manual':False}
                json.dump(dump,f)
                f.write(',\n')
        #print(cropped_image)
                cv2.imshow( "cropped",cropped_image )
