...
echo "running"
 ...
 python python main.py  -test drawer316_3.avi -record > drawer0/three.txt
 python python main.py  -test drawer316_4.avi -record > drawer0/four.txt
 python python main.py  -test drawer316_5.avi -record > drawer0/five.txt
