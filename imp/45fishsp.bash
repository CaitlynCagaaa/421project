...
echo "six"
 ...
 # wait $pid1
echo "seven"
 # python main.py  -test d45shadowbox/45_fishsp_8.avi -record > drawer3/eight.txt  &
 # pid1=$!
 # wait $pid1
echo "eight"
 # python main.py  -test d45shadowbox/45_fishsp_8.avi -record > drawer3/eight.txt  &
 ...
 # wait $pid1
echo "eight"
  #python main.py  -test d45shadowbox/45_fishsp_9.avi -record > drawer3/nine.txt  &
  #pid1=$!
 # wait $pid1
echo "nine"
 # python main.py  -test d45shadowbox/45_fishsp_10.avi -record > drawer3/ten.txt  &
 # pid1=$!
 # wait $pid1
echo "ten"
  echo "end"