...
def add_drawer():
    ...
    try:
        ...
        values = (data['DrawerNum'], data['DrawerBoxNum'], data['DrawerStartX'], data['DrawerStartY'], data['DrawerPixelWidth'], data['DrawerPixelHeight'], data['DrawerYAML'], data['DrawerPicAllTools'], data['DrawerPicNoTools'])
