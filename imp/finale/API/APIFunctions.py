...
def addTool(url, toolID, toolName, toolType, toolClassifierType, toolDrawerID, toolSymbolAvailable, toolSymbolPath, toolCheckedOut, toolStartX, toolStartY, toolPixelWidth, toolPixelHeight, toolPictureWithPath, toolPictureWithoutPath, toolInfoTakenManually):
    data = {
        'ToolID': toolID,
        'ToolName': toolName,
        'ToolType': toolType,
...
def addEvent(url, eventID, eventType, eventToolID, eventTimestamp, eventDrawerLocation, eventUserID, eventNotes):
    data = {
        'EventID': eventID,
        'EventType': eventType,
